...
import "./navbar.css"
import { Container, Col,Offcanvas, Alert, Row} from 'react-bootstrap';
import { useState, useContext, useEffect,  useLayoutEffect} from "react";
import { Link } from "react-router-dom";

import { FavoriteContext } from "../../Context/wishlist";
import { useAppDispatch, useAppSelector } from "../../redux/app/hook";
import { getAuthUser, getIsAuthenticated,  fetchAsyncLogout } from "../../redux/features/auth/authSlice";
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarTogglerDemo03">
      ...
      <ul className="navbar-nav nav justify-content-end">
        ...
        <li className="nav-item">
          <a className="nav-link active text-white"  href="/about-us">About us</a>
        </li>
...
<Container className="navbar-toggler border border-0 " fluid>
  ...
  <div className=" text-dark"> Account</div>
        ...
        <Link to="/category/Computing" className="text-decoration-none text-reset"><div className="bg-white   d-flex   text-black fw-medium">
