...
const {state} = useContext(FavoriteContext)
  ...
  {recommended?.map((items:ITEM, id) =>{
     return (
       ...
       <Link  to={`/product/${items._id}`} className="p-2 text-decoration-none text-reset"> <LazyLoadImage src={items.image} effect="blur" style={{ width: '130px', height: '130px' }}  className="" /></Link> 
