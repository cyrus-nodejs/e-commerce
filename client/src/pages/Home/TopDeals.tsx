...
// const authUser = useAppSelector(getAuthUser)
 ...
 <div className="p-2 text-primary">{items.title.substring(0, 25)}</div>
 {/* <div className="d-inline-flex gap-1 p-2 text-warning">{items.rating}{items.review}</div> */}
 <div className="p-2 text-danger ">{state.currency}{items.price}<span className="text-secondary mx-2   text-decoration-line-through">{state.currency}{items.price}</span></div>
  <div className="p-2  d-none d-sm-block">{items.description.substring(0, 90) + ".."}</div> 
