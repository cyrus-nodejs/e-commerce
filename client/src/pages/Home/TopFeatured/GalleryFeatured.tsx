...
import { ITEM } from "../../../utils/@types";
  ...
  import {  fetchTopFeaturedGallery, getTopFeaturedGallery } from "../../../redux/features/items/itemSlice";
...
{topFeaturedGallery?.map((item:ITEM, id) =>{
   return (
      ...
      <Col sm={5} className=" bg-white  " ><LazyLoadImage src={item.image}  style={{ width: '100px', height: '130px' }}  effect="blur"   className="" /></Col>
