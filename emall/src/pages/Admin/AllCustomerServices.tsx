import { fetchAdminAllCustomerService, getAdminAllCustomerService } from "../../redux/features/admin/adminSlice"
...
const allCustomerServices = useAppSelector(getAdminAllCustomerService)
// const isAuthenticated = useAppSelector(getIsAuthenticated)
const authUser = useAppSelector(getAuthUser)
 console.log(allCustomerServices)
useEffect(() =>{
  ...
  return (
    <Row  className='' >
    {allCustomerServices && allCustomerServices.length > 0  ? (<div>
      <div>
  <div className="d-inline-flex p-2 fs-4 border-info  border-bottom">All Customer Service Personnels</div>
</div>
    <div  className="row">

{allCustomerServices?.map((items:USER, id) =>{
 return (
