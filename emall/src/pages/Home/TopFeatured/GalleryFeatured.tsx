...
const {addRelatedItem, addViewedItem} = useContext(ItemContext)
  const handleTopFeatured = () => {
    ...
    const config ={
      method:"get",
      url:`https://server-de5v5fkag-cyrus-nodejs-projects.vercel.app/topfeaturedgallery`, 
...
{products.map((item:ITEM, id) =>{
   return (
      ...
      <Col sm={5} className=" bg-white  " style={{width:"",height:""}} ><Image src={`https://server-de5v5fkag-cyrus-nodejs-projects.vercel.app/items/${item.image}`} fluid   className="" /></Col>
