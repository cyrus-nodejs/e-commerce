...
{products.map((product:ITEM) =>{
   return (
    ...
    <Row  className=" d-flex flex-row">
      ...
      <Col className="container" >    <Link onClick={() =>{addViewedItem(product); addRelatedItem(product);   }}  to={`/product/${product.title}`} className="p-2 text-decoration-none text-reset"><Image src={product.image} fluid  className="" />    </Link></Col>
