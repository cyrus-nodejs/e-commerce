...
const Page1 = () => {
  ...
  return (
    ...
    >
       <span className=" text-outline-primary fw-bold">Page <span  id="myP"><i className='bx bxs-chevron-down'></i></span></span> 
    </Button>
    <Collapse in={open}>
    <Col id="collapse">
     ...
     <Button
      ...
      className="border border-0"
    >
       <span className=" text-outline-primary fw-bold">Page <span  id="myP"><i className='bx bx-chevron-up'></i></span></span> 
    </Button>
    <Collapse in={open}>
    <Col>
              <div className="bg-white  p-2    text-black fw-medium">Computer & Desktop</div>
